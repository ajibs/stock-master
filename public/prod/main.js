...
function generateURL(name) {
  ...
  const startDate = _generateDate2[0],
...
function loadHome() {
  companyArray.forEach(company => {
    const url = Object(__WEBPACK_IMPORTED_MODULE_1__helpers__["b" /* generateURL */])(company);
...
function realtime() {
  ...
  function retrieveStockData(companyStock, emitter) {
    const url = Object(__WEBPACK_IMPORTED_MODULE_1__helpers__["b" /* generateURL */])(companyStock);
    $.getJSON(url, stockData => {
      stockOptions.push({
        name: companyStock,
        data: Object(__WEBPACK_IMPORTED_MODULE_1__helpers__["a" /* formatChartData */])(stockData)
