...
var _loadHome = __webpack_require__(4);

var _loadHome2 = _interopRequireDefault(_loadHome);

var _realtime = __webpack_require__(5);
...
var _createChart = __webpack_require__(0);
...
function realtime() {
  ...
  function appendStockToScreen(name) {
    ...
    $('#' + name).click(function () {
      removeStock(_dompurify2.default.sanitize(this.id), true);
    });
  }
  ...
  $(function () {
    ...
    $('.addStockForm').submit(function (e) {
      e.preventDefault();
      var stockName = _dompurify2.default.sanitize($('#stockName').val().toLowerCase());
